...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='reports/front-wall-interior/local-cases.json')
    args = parser.parse_args()
    output = check.ROOT / args.output
    ...
    for seed in (1, 90601):
        for side in ('challenger', 'defender'):
            row = check.run_case(('RER', seed, side, 1, args.rounds, fingerprint,
    ...
    output.write_text(json.dumps({'scope': f'Local {args.rounds}-round cases, not official PASS',
