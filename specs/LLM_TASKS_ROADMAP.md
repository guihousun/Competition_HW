...
- [ ] P3：新闻推理已影响真实采矿策略，日期/来源/预算/更正测试通过；真实模型三日解释实验已结束但新闻失败，独立诊断证实一次4096 token截断。16384上限的单次同提示词对照返回完整新闻，尚需完整通道复测，见reports/llm-tasks-real-world。
- [ ] P4：多日记忆与购买/寻路/召唤已接通；四组420轮试验3组取得宝藏，存在一组负收益；真实解释和最终综合验收仍待完成。
- [ ] P5：14场1300轮脚本模型完整对局已完成（种子1/90713、双方阵营、含故障）；全功能四组均比仅任务得分低，暂不默认推广。仍需90317/90601完整对照、HTTP延迟、真实模型复测与正式包交付，见reports/llm-tasks-full-games。
