...
源码SHA：936c24e45be3886988e463548c959fbbbb1e35ea。包SHA256：38e677131376b8765df36ddf02e18656935d7cc14d33d35eade3783eb5156256，153006字节。Windows/Ubuntu Python3.11.10下原版入口、Linux bash run.sh、日志目录不可写、trace关闭、full模式共10项全部通过；每项25个POST，启用trace时25/25捕获。仅本地包验证，不是内网PASS。根目录tar.gz、sha256、manifest一起提交；源码提交与交付提交分开记录。
